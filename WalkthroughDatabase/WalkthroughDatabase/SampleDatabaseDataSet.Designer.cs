...
namespace WalkthroughDatabase {
    ...
    public partial class SampleDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomersRow AddCustomersRow(string CustomerId, string CompanyName, string ContactName, string Phone, string Zipcode) {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public OrdersRow AddOrdersRow(int OrderID, string CustomerID, System.DateTime OrderDate, int OrderQuantity) {
...
namespace WalkthroughDatabase.SampleDatabaseDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([CustomerId], [CompanyName], [ContactName], [Phone], [Zipcode]) VALUES (@CustomerId, @CompanyName, @ContactName, @Phone, @Zipcode);
SELECT CustomerId, CompanyName, ContactName, Phone, Zipcode FROM Customers WHERE (CustomerId = @CustomerId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [CustomerId] = @CustomerId, [CompanyName] = @CompanyName, [ContactName] = @ContactName, [Phone] = @Phone, [Zipcode] = @Zipcode WHERE (([CustomerId] = @Original_CustomerId) AND ([CompanyName] = @Original_CompanyName) AND ((@IsNull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactName] = @Original_ContactName)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Zipcode = 1 AND [Zipcode] IS NULL) OR ([Zipcode] = @Original_Zipcode)));
SELECT CustomerId, CompanyName, ContactName, Phone, Zipcode FROM Customers WHERE (CustomerId = @CustomerId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WalkthroughDatabase.Properties.Settings.Default.SampleDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerId, CompanyName, ContactName, Phone, Zipcode FROM dbo.Customers";
        ...
        public virtual int Delete(string Original_CustomerId, string Original_CompanyName, string Original_ContactName, string Original_Phone, string Original_Zipcode) {
        ...
        public virtual int Insert(string CustomerId, string CompanyName, string ContactName, string Phone, string Zipcode) {
            if ((CustomerId == null)) {
        ...
        public virtual int Update(string CustomerId, string CompanyName, string ContactName, string Phone, string Zipcode, string Original_CustomerId, string Original_CompanyName, string Original_ContactName, string Original_Phone, string Original_Zipcode) {
            if ((CustomerId == null)) {
                throw new global::System.ArgumentNullException("CustomerId");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CompanyName, string ContactName, string Phone, string Zipcode, string Original_CustomerId, string Original_CompanyName, string Original_ContactName, string Original_Phone, string Original_Zipcode) {
            return this.Update(Original_CustomerId, CompanyName, ContactName, Phone, Zipcode, Original_CustomerId, Original_CompanyName, Original_ContactName, Original_Phone, Original_Zipcode);
        }
    }
